...
namespace app\models\base\unidades;
 ...
 * @property int $uni_coddisp
 * @property int $uni_codtipo
 * @property int $uni_codsituacao
 * @property int $uni_codtipres
 * @property int $uni_permitirmodeloa
 *
...
class Unidades extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['uni_coddisp'], 'exist', 'skipOnError' => true, 'targetClass' => DisponibilizarsiteDisp::className(), 'targetAttribute' => ['uni_coddisp' => 'disp_coddisp']],
            [['uni_codsituacao'], 'exist', 'skipOnError' => true, 'targetClass' => SituacaosistemaSitsis::className(), 'targetAttribute' => ['uni_codsituacao' => 'sitsis_codsituacao']],
            [['uni_codtipo'], 'exist', 'skipOnError' => true, 'targetClass' => TipounidadeTiun::className(), 'targetAttribute' => ['uni_codtipo' => 'tiun_codtipo']],
            [['uni_codtipres'], 'exist', 'skipOnError' => true, 'targetClass' => TiporesponsavelTire::className(), 'targetAttribute' => ['uni_codtipres' => 'tire_codtipo']],
        ];
    }
